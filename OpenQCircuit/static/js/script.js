$(document).ready(function () {
    ...
    $(window).bind('hashchange', function () {
        ...
        if (hash === 'login') {
            ...
            url = app_page_url
        } else if (hash === 'circuit') {
            url = circuit_page_url
        } else {
            url = intro_page_url
        }
        if (url == circuit_page_url) {
            console.log('Circuit page loaded')
        } else {
            $.ajax({
                type: 'GET',
                url: url,
    ...
    $(document).on('click', '#playground-save-button', function () {

        var $item = $(this).parent().parent();
        var itemId = $item.data('id');
        var playgroundInput = $('#playground-input').val();
